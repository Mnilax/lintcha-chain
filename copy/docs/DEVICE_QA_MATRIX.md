# Lintcha Copy — device QA matrix (to be executed before beta; nothing executed yet)
...
|---|---|---|---|---|
| 1 | Telegram iOS | injected EIP-1193 absent (expected) | /copy → Open Lintcha Copy | label visible first; "no EIP-1193 wallet in this client" state; nothing else clickable |
...
| 16 | any | Core drain | queue review while Core cron runs | private-chat line arrives once; button points to the Copy origin |
